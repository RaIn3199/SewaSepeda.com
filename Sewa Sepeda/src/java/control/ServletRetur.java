...
public class ServletRetur extends pesan {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String kdcust=request.getParameter("customer");
            ...
            retur var = new retur(noretur,tglretur,kdcust,kdbarang,totretur,qtyretur,subretur);
            String URL = "beranda.jsp?halaman=retursewa&aksi=SIMPAN";
            if(aksi1 != null){
               ...
               out.print(super.proses2(var.toDelete(), URL, "HAPUS"));
                ...
                pstmt1 = kon.conn.prepareStatement("INSERT INTO retur_sewa values('" + retur.getNoretur() + "','"
                        + retur.getTglretur() + "','"
                        + retur.getTotretur() + "')");
                ...
                result2=pstmt2.executeUpdate();
                    if (result +result1 + result2 > 0) {
                        ...
                        + "document.location='beranda.jsp?hal=retursewa';"
                        + " </script>");   
                    }
            }
