...
<% java.util.Date waktu = new java.util.Date();
    ...
    <html>
        ...
        <body>
            <h1>Transaksi Sewa Sepeda</h1></br>
            <table border="0">
                <form action="sewaServlet" method="post">
                    ...
                    <%
                        ...
                        %>
                        <br/><br/>
                        <h3>Data Sepeda Untuk DiSewa</h3>
                        <table border="2">
                            <tr>
                                <th>Nomor</th>
                                <th>Kode Sepeda</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="sewaServlet?aksi=Delete&kodebarang=<%= rs.getString(2)%>">HAPUS</a>
                                </td>
                            </tr>
                            <% }%>
                        </table>
                        <table>
                            ...
                            <c:forEach var='ttlDK'items='${ttl.rowsByIndex}'><br>
                                <table border="0">
                                    <tr>
                                        <td>Total Jumlah Sepeda yang Di Sewa</td>
