        ...
        <div id="wrap">
            ...
            <div id="content"><%-- awal dari isi content --%>
                ...
                <ul>
                    ...
                    <li><a href="menu_sewa.jsp">Rental Sepeda</a></li>
                    <li><a href="member_sewa.jsp?hal=tampil-sewa">Member Rental</a></li>
                </ul>
                    <h2> Transaksi</h2>
                    <ul>
                    ...
                    <table width="100%">
                        <tr>
                            <td valign="top" width="110%">
                                ...
                                <c:choose>
                                    <c:when test="${param.hal=='tampil-sewa'}">
                                        <%@ include file="tampil_sewa.jsp"%>
                                    </c:when>
                                    <c:when test="${param.hal=='edit-sewa'}">
                                        <%@ include file="edit_sewa.jsp"%>
                                    </c:when>
                                    <c:when test="${param.hal=='input-sewa'}">
                                        <%@ include file="input_sewa.jsp"%>
                                    </c:when>
                                    <c:otherwise>
                                        <%@include file="tampil_sewa.jsp" %>
                                    </c:otherwise>
