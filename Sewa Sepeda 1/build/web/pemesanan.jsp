        ...
        <sql:query var="ttl" dataSource="${dataSource}">
            ...
            <table border="0">
                <form action="ServletPemesanan" method="post">
                    <h2>Data Barang</h2>
                    <tr>
                        <td>No Pesan</td>   <td>: <input type="text" name="no_pesan" id="nopesan" value="" readonly="readonly"/>
                    ...
                    <tr>
                        <td>Harga Barang</td>   <td>: <input type="text" name="harga" id="ename" value="" readonly="readonly" onkeyup="sumPesan();"></td>
                    </tr>
                    <tr>
            ...
            <table width="535" border="1" align="center">
                <tr align="center">
                    <td colspan="5"><h3>Data Barang Untuk Dipesan</h3></td>
                </tr>
                <tr>
                    <th>Kode Barang</th>
                    <th>Quantity</th>
                ...
                <c:forEach var='ttlDK'items='${ttl.rowsByIndex}'><br>
                    <table border="0">
                        <tr><td>Total Jumlah Barang Dipesan</td> <td>: <input type="text" readonly="readonly" name="totjum" size="1" value="${ttlDK[0]}"></td></tr>
